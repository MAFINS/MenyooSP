...
namespace BlipIcon {
	const std::map<int, std::string> vNames
	{
		...
		{ BlipIcon::UFO, "UFO" },
		{ BlipIcon::SeaSparrow2, "SeaSparrow2" },
		{ BlipIcon::Dinghy2, "Dinghy2" },
