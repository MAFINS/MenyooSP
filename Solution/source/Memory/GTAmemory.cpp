...
float GeneralGlobalHax::GetPlayerSwimSpeed()
{
	...
	if (baddr)
	{
		...
		if (gameVersion <= eGameVersion::VER_1_0_791_2_NOSTEAM)
			...
			return *(GetMultilayerPointer<float*>(baddr, std::vector<DWORD>{0x8, 0x10B8, 0x150}));
	}
	return 1.0f;
}
void GeneralGlobalHax::SetPlayerSwimSpeed(float value)
{
	...
	if (baddr)
	{
		...
		if (gameVersion <= eGameVersion::VER_1_0_791_2_NOSTEAM)
			...
			*(GetMultilayerPointer<float*>(baddr, std::vector<DWORD>{0x8, 0x10B8, 0x150})) = value;
	}
}
float GeneralGlobalHax::GetPlayerMovementSpeed()
{
	...
	if (baddr)
	{
		...
		if (gameVersion <= eGameVersion::VER_1_0_791_2_NOSTEAM)
			...
			return *(GetMultilayerPointer<float*>(baddr, std::vector<DWORD>{0x8, 0x10B8, 0xCD0}));
	}
	return 1.0f;
}
void GeneralGlobalHax::SetPlayerMovementSpeed(float value)
{
	...
	if (baddr)
	{
		...
		if (gameVersion <= eGameVersion::VER_1_0_791_2_NOSTEAM)
			...
			*(GetMultilayerPointer<float*>(baddr, std::vector<DWORD>{0x8, 0x10B8, 0xCD0})) = value;
	}
}
